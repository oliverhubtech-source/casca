...
DESKTOP_FILE="$APPLICATIONS_DIR/com.oliverhub.Casca.desktop"
...
sed "s|__PROJECT_DIR__|$PROJECT_DIR|g" "$PROJECT_DIR/casca/data/com.oliverhub.Casca.desktop.in" > "$DESKTOP_FILE"
chmod +x "$DESKTOP_FILE"

# Instala o ícone no tema do sistema, pra funcionar também na tela "Sobre o Casca" e no alt-tab.
cp "$PROJECT_DIR/casca/data/icons/com.oliverhub.Casca.svg" "$ICON_THEME_DIR/com.oliverhub.Casca.svg"
