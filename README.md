...
```bash
flatpak-builder --user --install --force-clean build-dir com.oliverhub.Casca.yml
flatpak run com.oliverhub.Casca
```
...
- `com.oliverhub.Casca.yml` / `python3-requirements.yaml` — manifest do Flatpak
...
`flatpak run --command=casca-webview com.oliverhub.Casca`.
